...
inline constexpr const char* ottSliderId = "ottSlider";
...
inline constexpr const char* sampleMonoSliderId = "sampleMonoSlider";
inline constexpr const char* samplePanSliderId = "samplePanSlider";
